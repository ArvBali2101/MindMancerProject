...
// Constructor: Initializes base SessionManager and stores reference to TimerCount
WorkSessionManager::WorkSessionManager(TaskLogger& logger, TimerCount& timerCount)
