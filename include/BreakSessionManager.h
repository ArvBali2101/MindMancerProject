...
// Inherits from SessionManager and uses a TimerCount reference to track progress.
class BreakSessionManager : public SessionManager
{
private:
    TimerCount& myTimerCount;   // Reference to shared TimerCount to track session flow
